...
- **Integration**: Uses chezmoi templates with `.chezmoidata/` YAML files to manage all packages across
...
1. **Validate**: `chezmoi apply --dry-run`
...
- **Prettier ecosystem**: prettier, prettier-plugin-_, @prettier/_
