...
const ThemeSwitcher: React.FC = () => {
	...
	const [activeThemeData, setActiveThemeData] = useState<ThemeOption>(
		themes[0],
	);
	...
	return (
		...
		>
			...
			<p className="text-gray-300 mb-6">
				Experience the beauty of Catppuccin in four delicious flavors that
			...
			<div
				...
				style={{ backgroundColor: activeThemeData.colors.background }}
			>
				<div
					className="flex items-center"
					style={{ color: activeThemeData.colors.text }}
				>
					<span className="font-mono mr-2">$</span>
					<span className="font-mono">
						echo &quot;Catppuccin {activeTheme} is delicious!&quot;
					</span>
				</div>
			</div>
		</motion.div>
