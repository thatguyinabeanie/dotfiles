-- Custom filetype detection for Chezmoi template files
-- Only applies to files within chezmoi directories

-- Override template filetype with compound types for better syntax support
